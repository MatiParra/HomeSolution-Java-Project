...
public class HomeSolutionTest {
    ...
    public void testFinalizarProyectoConFechaInvalidaLanzaExcepcion() {
        Integer numeroProyecto = (homeSolution.proyectosPendientes().get(0)).getValor1();
        homeSolution.finalizarProyecto(numeroProyecto, "2025-12-04"); /* 	La fecha pasada por parámetro 
        																	es posterior a la fecha de inicio.
        																	Es válida ya que es la unica validacion 
        																	que pide la interfaz IHomeSolution
        */
    }
    ...
    public void testCalculaCostoConRetrasosCorrectamente() throws Exception{
        Integer numeroProyecto = (homeSolution.proyectosPendientes().get(0)).getValor1();
        asignarTareas(numeroProyecto);
      /*  homeSolution.registrarRetrasoEnTarea(numeroProyecto, "Pintar", 1); 
        																		con esta linea y el cambio en la clase Tarea, el test funciona 
        																		sin embargo, encontramos una especie de ambugüedad. 
        																		el retraso no es explicito, esta implicito en la fecha de finalizacion.
        																		ya que esta es posterior a la fecha estimada de finalizacion, por lo tanto,
        																		si hubo retrasos no registrados */
        homeSolution.finalizarProyecto(numeroProyecto,"2025-12-10");
